...
if (isReleaseBuild) {
  starlightPlugins.unshift(starlightLinksValidator());
}
    ...
    starlight({
      ...
      social: [
        ...
        },
        {
          icon: "youtube",
          label: "YouTube",
          href: "https://www.youtube.com/@MarshalXuan",
        },
        {
          icon: "facebook",
          label: "Facebook",
          href: "https://www.facebook.com/nice.jade.yang",
        },
        { icon: "x.com", label: "X", href: "https://x.com/MarshalXuan" },
        {
          icon: "github",
          label: "GitHub",
          href: "https://github.com/nicejade/gpt-wordbook",
        },
      ],
      customCss: [
      ...
      head: [
        ...
        },
        {
          ...
          attrs: {
            name: "keywords",
            content:
              "GPT Wordbook,英语单词书,GPT-4,单词学习,词根词缀,英语词汇,AI学习,词汇记忆,英语学习,单词记忆技巧",
          },
        },
        {
          tag: "meta",
        ...
        },
        {
          ...
          attrs: {
            ...
            content:
              "智析单词书（GPT Wordbook）是 AI 驱动的深度英语词汇学习平台，精选 11000+ 核心词汇，利用 GPT 模型深度解析每个单词的词义、发音、例句、词根、词缀、同义词、反义词、文化内涵与使用场景，从理解本质出发构建长期记忆。",
          },
        },
        {
          tag: "meta",
        ...
        },
        {
          ...
          attrs: {
            ...
            content:
              "智析单词书 | GPT Wordbook - AI 赋能的深度词汇学习平台 预览图",
          },
        },
        ...
        // Google AdSense - 延迟加载
        {
          tag: "script",
          content:
            "window.addEventListener('load',function(){var s=document.createElement('script');s.src='https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-8586652723015758';s.async=true;s.crossOrigin='anonymous';document.head.appendChild(s)});",
        },
      ],
