...
3.  This journey is of great importance. (这次旅行非常重要。)
...
"Important"词中， "im-"是前缀，意为"进入"或"向内"（源自 in-）。 "-port-"是词根，来源于拉丁文表示"携带"的含义。"-ant"是形容词后缀，表示具有某种性质。
我可以提供一些具有相同词根 "port" 的单词，以便你记忆，如：Export (出口/携带出), Report (报告/带回), Transport (运输/穿梭携带)。
